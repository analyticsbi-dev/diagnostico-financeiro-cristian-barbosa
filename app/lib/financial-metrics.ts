...
export function calculateFinancialMetrics(d: Diagnostic) {
  ...
  const monthlyOutflows = taxes + purchases + payroll + admin + financialExpense;
  const netRevenue = revenue - taxes, grossResult = netRevenue - purchases, operatingResult = revenue - monthlyOutflows;
