...
export function Login({ error = false }: { error?: boolean }) {
  ...
  return <main className="login-shell"><section className="login-story" aria-label="Apresentação do painel">
    <div className="brand"><span className="brand-mark">CB</span><span><strong>Cristian Barbosa</strong><small>Consultor Financeiro</small></span></div>
    ...
    <div className="mini-brand"><span className="brand-mark">CB</span></div><span className="eyebrow">Acesso restrito</span><h2>Bem-vindo, Cristian</h2><p>Entre para acessar os diagnósticos das empresas.</p>
